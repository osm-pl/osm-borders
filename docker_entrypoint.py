...
def get_nosplit_borders(terc):
    return borders.borders.get_borders(
...
def main():
    ...
    parser.add_argument("terc", nargs="?", help="TERC code of municipiality", type=str)
    ...
    parser.add_argument(
        "--server",
        help="run REST server. Overrides all other options",
        action="store_true",
    )
